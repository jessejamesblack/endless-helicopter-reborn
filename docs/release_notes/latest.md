# Endless Helicopter Reborn 1.6.4

Version 1.6.4 is the next stable Android release. It packages the reinstall-restore fixes for Android, the dedicated title screen flow, clearer synced best-score behavior, and live account cleanup for legacy split identities.
